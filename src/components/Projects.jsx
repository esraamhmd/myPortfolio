...
const PROJECTS = [
  {
    ...
    tags: ['React.js', 'TypeScript', 'Redux Toolkit', 'React Router', 'DummyJSON API'],
  ...
  desc: 'A full-stack banking web app with JWT authentication, money transfers, deposits, withdrawals, transaction history and an admin panel backed by a real MongoDB database.',
  tags: [
  'Next.js',
  'React.js',
  'TypeScript',
