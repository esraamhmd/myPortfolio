      ...
      <Container maxWidth="lg">
        <Box sx={{ textAlign: 'center', mb: 8 }}>
          <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 1, mb: 1 }}>
            ...
            <Typography variant="overline" aria-hidden="true" sx={{ color: ac, fontFamily: FONT, fontWeight: 600, letterSpacing: 3 }}>
              My Background
            </Typography>
          </Box>
          <Typography variant="h2" sx={{ color: 'text.primary', fontFamily: FONT, fontWeight: 800, fontSize: { xs: '2.2rem', md: '3rem' } }}>
            <Box component="span" sx={{ color: ac }}>Education</Box>
          </Typography>
        </Box>
        ...
        <Paper elevation={0} sx={{
          ...
          <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 3, flexWrap: { xs: 'wrap', sm: 'nowrap' } }}>
            <Box sx={{ flexShrink: 0, width: 64, height: 64, borderRadius: 3, bgcolor: 'rgba(233,30,140,0.12)', border: '2px solid rgba(233,30,140,0.38)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: ac, boxShadow: '0 4px 20px rgba(233,30,140,0.20)' }}>
              <AccountBalanceIcon sx={{ fontSize: 32 }} />
            </Box>

            <Box sx={{ flex: 1 }}>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: 1, mb: 1 }}>
                <Chip label="University" size="small" sx={{ bgcolor: 'rgba(233,30,140,0.12)', color: ac, border: '1px solid rgba(233,30,140,0.30)', fontSize: '0.75rem', fontWeight: 700, height: 24 }} />
              ...
              <Typography sx={{ color: ac, fontFamily: FONT, fontWeight: 600, fontSize: '1rem', mb: 0.4 }}>
