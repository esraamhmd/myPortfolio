    ...
    >
      <Box
        sx={{
          ...
          pointerEvents: "none",
          background:
            "radial-gradient(circle,rgba(114,47,153,0.10) 0%,transparent 70%)",
        }}
      />
      <Box
        sx={{
            ...
            {CERTIFICATES.map((c, i) => (
              <Box
                ...
                sx={{
                  ...
                  boxShadow: `0 4px 24px ${c.color}14`,
                  transition: "all 0.3s cubic-bezier(0.34,1.56,0.64,1)",
                  "&:hover": {
                    transform: "translateY(-8px)",
                    borderColor: c.color,
                    boxShadow: `0 20px 60px ${c.color}35`,
                  },
                }}
              >
                {/* Certificate image */}
                ...
                >
                  ...
                  <Box
                    sx={{
                      position: "absolute",
                      inset: 0,
                      background: `linear-gradient(to top, ${c.color}30 0%, transparent 60%)`,
                      pointerEvents: "none",
                    }}
                  />
                </Box>
            ...
            <>
              ...
              <Box
                sx={{
                  ...
                  alignItems: "center",
                  p: 1.5,
                  borderBottom: `1px solid ${modal.color}20`,
                  bgcolor: "background.paper",
                  ...
                  >
                    ...
                    <IconButton
                      ...
                      sx={{
                        ...
                        "&:hover": { bgcolor: "rgba(233,30,140,0.4)" },
                      }}
                    >
                      <CloseIcon />
                    </IconButton>
                    ...
                    >
                      <IconButton
                        ...
                        sx={{
                          ...
                          fontSize: 20,
                          fontWeight: 700,
                          "&:hover": { bgcolor: "rgba(233,30,140,0.15)" },
                        }}
                      >
                        −
                      </IconButton>
