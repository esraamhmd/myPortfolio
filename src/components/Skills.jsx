...
const SKILLS = [
  ...
  { name: 'Next.js',        icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nextjs/nextjs-original.svg',              color: '#ffffff', url: 'https://nextjs.org/docs' },
  ...
  { name: 'React Router',   icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/reactrouter/reactrouter-original.svg',    color: '#ca4245', url: 'https://reactrouter.com' },
  { name: 'Tanstack Query', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg',                color: '#ff4154', url: 'https://tanstack.com/query/latest' },
  ...
  { name: 'Jest',           icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/jest/jest-plain.svg',                     color: '#c21325', url: 'https://jestjs.io/docs' },
  { name: 'AWS',            icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/amazonwebservices/amazonwebservices-plain-wordmark.svg', color: '#ff9900', url: 'https://docs.aws.amazon.com' },
  { name: 'Docker',         icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/docker/docker-original.svg',              color: '#2496ed', url: 'https://docs.docker.com' },
  ...
  { name: 'Postman',        icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postman/postman-original.svg',            color: '#ff6c37', url: 'https://learning.postman.com/docs' },
